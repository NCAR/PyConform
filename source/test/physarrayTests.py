...
class PhysArrayBinOpTests(PhysArrayTests):
    ...
    def test_add(self):
        expvals = {(0, 1): PhysArray(2.0, name='(1.0+Y)'),
                   ...
                   (10, 11): PhysArray([[2.0, 5.0], [5.0, 8.0]], name='(X+transpose(Y, from=[y,x], to=[x,y]))',
                                       dimensions=('x', 'y')),
                   (11, 12): PhysArray([[2.0, 5.0], [5.0, 8.0]], name='(up(X)+transpose(Y, from=[x,y], to=[y,x]))',
                                       dimensions=('y', 'x'), positive='up'),
                   (12, 13): PhysArray([[0.0, -1.0], [1.0, 0.0]], name='(X+up(transpose(Y, from=[y,x], to=[x,y])))',
                                       dimensions=('x', 'y'), positive='up')}
