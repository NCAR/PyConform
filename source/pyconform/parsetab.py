...
_lr_productions = [
  ...
  ('array_like -> UFLOAT','array_like',1,'p_array_like','parsing.py',94),
  ('array_like -> UINT','array_like',1,'p_array_like','parsing.py',95),
  ('array_like -> function','array_like',1,'p_array_like','parsing.py',96),
  ('array_like -> variable','array_like',1,'p_array_like','parsing.py',97),
  ('array_like -> ( array_like )','array_like',3,'p_array_like_group','parsing.py',104),
  ('function -> NAME ( argument_list , keyword_dict )','function',6,'p_function_with_arguments_and_keywords','parsing.py',111),
  ('function -> NAME ( argument_list )','function',4,'p_function_with_arguments_only','parsing.py',118),
  ('function -> NAME ( keyword_dict )','function',4,'p_function_with_keywords_only','parsing.py',125),
  ('argument_list -> argument_list , argument','argument_list',3,'p_argument_list_append','parsing.py',132),
  ('argument_list -> argument','argument_list',1,'p_single_item_argument_list','parsing.py',139),
  ('argument_list -> <empty>','argument_list',0,'p_single_item_argument_list','parsing.py',140),
  ('argument -> array_like','argument',1,'p_argument','parsing.py',147),
  ('argument -> STRING','argument',1,'p_argument','parsing.py',148),
  ('keyword_dict -> keyword_dict , NAME = argument','keyword_dict',5,'p_keyword_dict_setitem','parsing.py',155),
  ('keyword_dict -> NAME = argument','keyword_dict',3,'p_single_item_keyword_dict','parsing.py',163),
  ('variable -> NAME [ index_list ]','variable',4,'p_variable','parsing.py',170),
  ('variable -> NAME','variable',1,'p_variable','parsing.py',171),
  ('index_list -> index_list , index','index_list',3,'p_index_list_append','parsing.py',179),
  ('index_list -> index','index_list',1,'p_single_item_index_list','parsing.py',186),
  ('index -> slice','index',1,'p_index','parsing.py',193),
  ('index -> array_like','index',1,'p_index','parsing.py',194),
  ('slice -> slice_argument : slice_argument : slice_argument','slice',5,'p_slice','parsing.py',201),
  ('slice -> slice_argument : slice_argument','slice',3,'p_slice','parsing.py',202),
  ('slice_argument -> array_like','slice_argument',1,'p_slice_argument','parsing.py',209),
  ('slice_argument -> <empty>','slice_argument',0,'p_slice_argument','parsing.py',210),
  ('array_like -> - array_like','array_like',2,'p_expression_unary','parsing.py',217),
  ('array_like -> + array_like','array_like',2,'p_expression_unary','parsing.py',218),
  ('array_like -> array_like POW array_like','array_like',3,'p_expression_binary','parsing.py',231),
  ...
  ('array_like -> array_like < array_like','array_like',3,'p_expression_binary','parsing.py',236),
  ('array_like -> array_like > array_like','array_like',3,'p_expression_binary','parsing.py',237),
  ('array_like -> array_like LEQ array_like','array_like',3,'p_expression_binary','parsing.py',238),
  ('array_like -> array_like GEQ array_like','array_like',3,'p_expression_binary','parsing.py',239),
  ('array_like -> array_like EQ array_like','array_like',3,'p_expression_binary','parsing.py',240),
]
