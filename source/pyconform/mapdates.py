    ...
    for i in range(1, len(keys)):
        if date_info[keys[i]]['t_per'] == 'mon':
            ...
            if (next_val == new_date[1]):
                ...
                print("Disconnect? Expected: {} Got: {}".format(next_val, new_date[1]))
                return 1
        else:
            if (next_val == date_info[keys[i]]['t0']):
                ...
                print("Disconnect? Expected: {} Got: {}".format(next_val, date_info[keys[i]]['t0']))
                return 1
    ...
    if t_per == 'mon':
        ...
        for i in range(1, len(t)):
            ...
            if (next_val == new_date[1]):
                ...
                print("Disconnect? Expected: {} Got: {} around time step: {}".format(next_val,new_date[1], i))
                return 1
    ...
    # slices.
        ...
        for i in range(1, len(t)):
            if (prev_time + t_step == t[i]):
                ...
                print("Disconnect? Expected: {} Got: {} around time step: {}".format(prev_time+t_step,t[i], i))
                return 1
    return 0
